...
:black_small_square: Create a 2nd method called calculateHighScorePosition. It should be sent one argument only., the player score. It should return an int. The return data should be :
...
:black_small_square: Call both methods and display the results of the following: a score of 1500, 900, 400 and 50
		...
		displayHighScorePosition("Elnar", highScorePosition);
	}
