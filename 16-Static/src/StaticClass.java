...
public class StaticClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(static1.getName()+ " is instance number" + static2.getNumInstance());
		
		StaticTest static3 = new StaticTest ("instance-3");
		System.out.println(static1.getName()+ " is instance number" + static3.getNumInstance());
